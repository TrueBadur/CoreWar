...
/*   Updated: 2019/10/30 18:21:34 by wgorold          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_LAB "Label name contain not allowed char in \"%.*s\" <- \'%c\' "
...
# define ERR_LEX__ID_C_NO_START 14
# define LEX_ERR_MSG_C_NO_START "line of command isn't complete. No char \""
...
# define ERR_LEX__ID_LONG_CMT 19
# define LEX_ERR_MSG_LONG_CMT "Size of .comment more than should be. %d vs %d"
...
int					long_name(t_lexdata *dat, char *start,
					t_list *lines, char **to_set);
...
int					add_token(t_lexdata *dat, char token_type,
					int data, char *label);
...
void				process_token_type(char tkn_typ, char *type,
					char *sub, char *val);
